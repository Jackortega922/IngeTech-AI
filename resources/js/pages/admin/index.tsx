...
function tabInicial(): Sub {
    ...
    return TABS.some((t) => t.value === valor)
        ? (valor as Sub)
        : 'dashboard';
}
...
export default function AdminIndex() {
    ...
    const [dashboard, setDashboard] =
        useState<DashboardAdmin | null>(null);
            ...
            <div className="min-h-full flex-1 bg-background">
                <div className="mx-auto flex max-w-[1600px] flex-col gap-6 p-4 md:p-6 lg:p-8">
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
                                Gestiona el catálogo tecnológico,
                                estudiantes, software y carreras
                        ...
                        <button
                            onClick={() => void cargar()}
                            disabled={cargando}
                            className="inline-flex items-center justify-center gap-2 rounded-xl border bg-card px-4 py-2.5 text-sm font-semibold shadow-sm transition hover:bg-muted disabled:cursor-not-allowed disabled:opacity-60"
                        >
                            <RefreshCw
                                className={`h-4 w-4 ${
                                    cargando
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Administra la información de esta sección.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {!catalogos || cargando ? (
                        ...
                        <TablaHardware
                            equipos={catalogos.hardware}
                            onCambio={cargar}
                            avisar={avisar}
                        />
                    ) : sub === 'software' ? (
                        <TablaSoftware
                            items={catalogos.software}
                            onCambio={cargar}
                            avisar={avisar}
                        />
                    ) : (
        ...
        <div className="space-y-5">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        {filas.length} equipos registrados
                        en el catálogo.
                    </p>
                </div>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={guardarTodo}
                        disabled={guardando}
                        className="inline-flex items-center gap-2 rounded-xl border bg-card px-4 py-2.5 text-sm font-bold transition hover:bg-muted disabled:opacity-50"
                    >
            ...
            <div className="flex flex-col gap-3 rounded-2xl border bg-card p-4 shadow-sm md:flex-row">
                <div className="relative flex-1">
                    ...
                    <input
                        className="w-full rounded-xl border bg-background py-2.5 pl-10 pr-4 text-sm outline-none transition focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/10"
                ...
                <select
                    className="rounded-xl border bg-background px-4 py-2.5 text-sm outline-none focus:border-cyan-500"
                    value={tipoFiltro}
                    onChange={(e) =>
                        setTipoFiltro(
                            e.target.value,
                ...
                <div className="flex items-center justify-center rounded-xl border px-4 text-sm text-muted-foreground">
                                ...
                                (f) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="p-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="min-w-[210px]">
                                                        <input
                                                            className="campo w-full rounded-lg border bg-background px-2 py-1 font-semibold"
                                                            value={
                                                                f.marca
                                                            }
                                                            onChange={(
                                                        ...
                                                        <input
                                                            className="campo mt-1 w-full rounded-lg border bg-background px-2 py-1 text-xs text-muted-foreground"
                                                            value={
                                                                f.modelo
                                                            }
                                                            onChange={(
                                            ...
                                            <td className="p-2">
                                                <input
                                                    className="campo w-48 rounded-lg border bg-background px-2 py-2"
                                                    value={
                                                        f.cpu
                                                    }
                                                    onChange={(
                                            ...
                                            <td className="p-2">
                                                <input
                                                    className="campo w-20 rounded-lg border bg-background px-2 py-2"
                                                    type="number"
                                                    min="0"
                                                    value={
                                                        f.rendimiento_score ??
                                            ...
                                            <td className="p-2">
                                                <div className="flex items-center gap-1">
                                                    <input
                                                        className="campo w-16 rounded-lg border bg-background px-2 py-2"
                                                        type="number"
                                                        min="1"
                                                        value={
                                                            f.ram_gb
                                            ...
                                            <td className="p-2">
                                                <div className="space-y-1">
                                                    <input
                                                        className="campo w-40 rounded-lg border bg-background px-2 py-2"
                                                        value={
                                                            f.gpu
                                                        }
                                                        onChange={(
                                                    ...
                                                    <select
                                                        className="w-40 rounded-lg border bg-background px-2 py-1 text-xs"
                                                        value={String(
                                                            f.gpu_dedicada,
                                                        )}
                                                        onChange={(
                                            ...
                                            <td className="p-2">
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <input
                                                        className="campo w-24 rounded-lg border bg-background px-2 py-2 font-semibold"
                                                        type="number"
                                                        min="0"
                                                        value={Number(
                                                            f.precio_soles,
            ...
            <div className="rounded-2xl border bg-card p-5 shadow-sm">
                <div className="mb-4 flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Texto utilizado para presentar cada equipo.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid gap-3 md:grid-cols-2">
                    {filas.map((f, i) => (
                        ...
                        >
                            ...
                            <input
                                className="campo w-full rounded-xl border bg-background px-3 py-2.5 text-sm outline-none focus:border-cyan-500"
                                value={
                                    f.descripcion ??
                                    ''
                                }
...
function TablaSoftware({
    ...
    async function eliminar(id: number) {
        const confirmar =
            window.confirm(
                '¿Estás seguro de eliminar este software?',
            );
        ...
        <div className="space-y-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Configura los requisitos mínimos y recomendados.
                    </p>
                </div>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={guardarTodo}
                        disabled={guardando}
                        className="inline-flex items-center gap-2 rounded-xl border px-4 py-2.5 text-sm font-bold transition hover:bg-muted disabled:opacity-50"
                    >
                        <CheckCircle2 className="h-4 w-4" />
                        {guardando
                            ? 'Guardando...'
            ...
            <div className="relative">
                ...
                <input
                    className="w-full rounded-xl border bg-card py-3 pl-10 pr-4 text-sm shadow-sm outline-none focus:border-cyan-500"
                            ...
                            {filtrados.map((f) => {
                                ...
                                return (
                                    ...
                                    >
                                        <td className="p-2">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="min-w-[220px]">
                                                    <input
                                                        className="w-full rounded-lg border bg-background px-2 py-1 font-semibold"
                                                        value={
                                                            f.nombre
                                                        }
                                                        onChange={(
                                        ...
                                        <td className="p-2">
                                            <input
                                                className="w-36 rounded-lg border bg-background px-2 py-2"
                                                value={
                                                    f.categoria
                                                }
                                                onChange={(
                ...
                <div className="grid gap-3 md:grid-cols-2">
                    {filas.map((f, i) => (
                        ...
                        >
                            ...
                            <input
                                className="w-full rounded-xl border bg-background px-3 py-2.5 text-sm outline-none focus:border-cyan-500"
                                value={
                                    f.descripcion ??
                                    ''
                                }
    ...
    async function guardarTodo() {
        try {
            ...
            avisar(
                e instanceof Error
                    ? e.message
                    : 'No se pudieron guardar las carreras.',
            );
        } finally {
            setGuardando(false);
        }
        ...
        <div className="space-y-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Relaciona las carreras con el software utilizado.
                    </p>
                </div>
                                    ...
                                    >
                                        <td className="p-2">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <input
                                                    className="w-72 rounded-lg border bg-background px-3 py-2 font-semibold"
                                                    value={
                                                        f.nombre
                                                    }
                                                    onChange={(
                                        ...
                                        <td className="p-2">
                                            <input
                                                className="w-52 rounded-lg border bg-background px-3 py-2"
                                                value={
                                                    f.facultad
                                                }
                                                onChange={(
            ...
            <div className="rounded-2xl border bg-card p-5 shadow-sm">
                <div className="mb-3 flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="font-bold">
                            Claves de software disponibles
                        </h3>
                        <p className="text-xs text-muted-foreground">
                            Usa estas claves al relacionar software con una carrera.
                        </p>
                    </div>
                </div>
...
function PanelDashboard({
    ...
    const hayConsultas =
        dashboard.total_consultas > 0;

    const maxCarrera = hayConsultas
        ? Math.max(
              ...Object.values(
                  dashboard.por_carrera,
              ),
              1,
          )
        : 1;

    const maxBucket = hayConsultas
        ? Math.max(
              ...Object.values(
                  dashboard.por_presupuesto,
              ),
              1,
          )
        : 1;
            ...
            {!hayConsultas ? (
                <div className="rounded-2xl border bg-card p-12 text-center shadow-sm">
                    ...
                    <p className="mx-auto mt-1 max-w-md text-sm text-muted-foreground">
                        Cuando los estudiantes utilicen
                        el recomendador, aquí aparecerán
            ...
            <div className="rounded-2xl border bg-card p-5 shadow-sm">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Usuarios que utilizan el sistema de recomendaciones.
                        </p>
                    </div>

                    <div className="rounded-xl bg-cyan-500/10 px-4 py-2 text-sm font-bold text-cyan-600">
