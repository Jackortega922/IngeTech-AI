            ...
            <main className="min-h-screen overflow-hidden bg-[#07111f] text-white">
                <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
                    ...
                    <div className="hidden items-center gap-8 text-sm text-slate-300 md:flex">
                        <a href="#como-funciona" className="transition hover:text-cyan-400">Cómo funciona</a>
                        <a href="#beneficios" className="transition hover:text-cyan-400">Beneficios</a>
                        <Link href="/login" className="rounded-lg border border-slate-600 px-5 py-2.5 hover:border-cyan-400">Ingresar</Link>
                    </div>
                </nav>
                ...
                <section className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 py-20 lg:grid-cols-2 lg:px-10 lg:py-32">
                    ...
                    <div className="relative">
                        ...
                        <h1 className="max-w-2xl text-5xl font-black leading-[1.05] tracking-tight sm:text-7xl">
                        ...
                        <div className="mt-10 flex flex-wrap gap-4">
                            <Link href="/register" className="rounded-xl bg-cyan-400 px-7 py-4 font-bold text-[#07111f] shadow-lg shadow-cyan-400/20 transition hover:bg-cyan-300">
                                Comenzar recomendación →
                            </Link>
                            <a href="#como-funciona" className="rounded-xl border border-slate-600 px-7 py-4 font-semibold text-slate-200 transition hover:border-cyan-400">
                                Conocer más
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="rounded-3xl border border-white/10 bg-white/[0.06] p-5 shadow-2xl backdrop-blur">
                            <div className="rounded-2xl bg-[#0d1d31] p-6">
                                <div className="mb-8 flex items-center justify-between">
                                    ...
                                    <div className="grid h-20 w-20 place-items-center rounded-full border-4 border-cyan-400 text-xl font-bold text-cyan-400">96%</div>
                                </div>
                                <div className="mb-6 h-40 rounded-xl bg-gradient-to-br from-slate-700 to-slate-900 p-8 text-center text-7xl">💻</div>
                                <div className="grid grid-cols-3 gap-3 text-center text-xs">
                                    <div className="rounded-lg bg-white/5 p-3"><b className="block text-cyan-300">16 GB</b><span className="text-slate-500">RAM</span></div>
                                    <div className="rounded-lg bg-white/5 p-3"><b className="block text-cyan-300">512 GB</b><span className="text-slate-500">SSD</span></div>
                                    <div className="rounded-lg bg-white/5 p-3"><b className="block text-cyan-300">M3</b><span className="text-slate-500">Chip</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="beneficios" className="border-t border-white/10 bg-[#091827] px-6 py-20 lg:px-10">
                    <div className="mx-auto max-w-7xl">
                        <p className="text-sm font-bold uppercase tracking-[0.25em] text-cyan-400">Una mejor decisión</p>
                        <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Tecnología pensada para tu futuro</h2>
                        <div className="mt-12 grid gap-5 md:grid-cols-3">
                            {features.map((feature) => (
                                <article key={feature.title} className="rounded-2xl border border-white/10 bg-white/[0.04] p-7 transition hover:-translate-y-1 hover:border-cyan-400/50">
                ...
                <section id="como-funciona" className="px-6 py-20 text-center lg:px-10">
                    ...
                    <p className="mx-auto mt-4 max-w-xl text-slate-400">Cuéntanos quién eres, qué haces y cuánto quieres invertir. Nosotros hacemos el análisis.</p>
